...
router.post('/', authenticateToken, async (req, res) => {
  try {
    ...
    // 计算原价
    let originalPrice = resource.price * duration;
    ...
    try {
      ...
      const [result] = await connection.query(
        ...
        [orderNo, userId, resourceId, resource.cloud_provider_id, resource.cloud_provider_code,
         resource.model, duration, durationUnit, originalPrice, discountAmount,
         voucherAmount, finalPrice, voucherId, discountId, remark]
      );
