...
export default function ComputingPower() {
  ...
  const handleOrder = (resource: GPUResource) => {
    ...
    calculatePrice(resource, 1, "hour", null);
  ...
  const calculatePrice = async (
    ...
    const original = resource.price * dur;
  ...
  }, [duration, durationUnit, selectedVoucher]);
        ...
        <div className="bg-gray-800/50 border-b border-gray-700">
          <div className="container py-4">
            <div className="flex gap-4 flex-wrap items-center">
              ...
              {/* 区域 */}
              <div className="flex items-center gap-2">
                <label className="text-sm text-gray-400">区域</label>
                ...
                return (
                  <Card key={gpu.id} className="bg-gray-800 border-gray-700 hover:border-blue-500 transition-all">
                    <CardContent className="p-6">
                      ...
                      {/* GPU型号 */}
                      <h3 className="text-xl font-bold mb-2">{gpu.model}</h3>
                      <p className="text-sm text-gray-400 mb-4">{gpu.region}</p>
                      ...
                      <div className="border-t border-gray-700 pt-4 mb-4">
                        <div className="flex items-baseline gap-2">
                          ...
                          <span className="text-sm text-gray-400">/{gpu.price_unit}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-400">
                          库存: {gpu.stock > 0 ? `${gpu.stock}台` : '已售罄'}
                        </span>
                        <Button
